...
export class ScaleBar {
    ...
    line: d3.Selection<d3.BaseType, unknown, HTMLElement, any>;
    startText: d3.Selection<SVGTextContentElement, unknown, HTMLElement, any>;
    endText: d3.Selection<SVGTextContentElement, unknown, HTMLElement, any>;
    loaded: boolean;
