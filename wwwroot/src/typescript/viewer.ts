...
export class Viewer {
    ...
    base: d3.Selection<d3.BaseType,unknown , HTMLElement, unknown>; // the parent container of the whole viewer
//    base: d3.Selection<d3.BaseType, {}, HTMLElement, any>; // the parent container of the whole viewer

    canvas: d3.Selection<HTMLCanvasElement, unknown, HTMLElement, unknown>; // the canvas element - displays the image of the slide
    ...
    public createCanvas(callback) {
        ...
        console.log('d3-0: ', this.containerId);
        this.base = d3.select(this.containerId);
        console.log('d3-1: ', this.base);
        ...
        zoomBehaviour.transform(this.canvas as any, this.transform);
